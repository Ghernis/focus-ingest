	...
	return []aggPublishSpec{
		...
		},
		{
			aggCopySpec: aggCopySpec{
				...
				localWhere: fmt.Sprintf(`month_start = '%s'`, m),
				serverCols: `month_start, provider, resource_sk, service_sk, application_sk, environment, prior_month_start, prior_sku_sk, current_sku_sk, prior_unit_rate, current_unit_rate, post_change_quantity, realized_savings_unit, realized_savings_cost_delta, projected_annual_savings, change_direction, refreshed_utc`,
				localCols:  `month_start, provider, resource_sk, service_sk, application_sk, environment, prior_month_start, prior_sku_sk, current_sku_sk, prior_unit_rate, current_unit_rate, post_change_quantity, realized_savings_unit, realized_savings_cost_delta, projected_annual_savings, change_direction, refreshed_utc`,
				colCount:   17,
			},
			grainCols:  []int{0, 1, 2, 3},
			grainNorms: []grainNorm{grainNormDate, grainNormFold, grainNormInt, grainNormInt},
			sumDecCols: []int{9, 10, 11, 12, 13, 14},
		...
		},
		{
			aggCopySpec: aggCopySpec{
				...
				localWhere: fmt.Sprintf(`month_start = '%s'`, m),
				serverCols: `month_start, provider, resource_sk, service_sk, application_sk, environment, change_date, prior_sku_sk, new_sku_sk, days_on_prior_sku, days_on_new_sku, realized_savings_unit, realized_savings_cost_delta, projected_annual_savings, change_direction, refreshed_utc`,
				localCols:  `month_start, provider, resource_sk, service_sk, application_sk, environment, change_date, prior_sku_sk, new_sku_sk, days_on_prior_sku, days_on_new_sku, realized_savings_unit, realized_savings_cost_delta, projected_annual_savings, change_direction, refreshed_utc`,
				colCount:   16,
			},
			grainCols:  []int{0, 1, 2, 3, 6, 8},
			grainNorms: []grainNorm{grainNormDate, grainNormFold, grainNormInt, grainNormInt, grainNormDate, grainNormInt},
			sumDecCols: []int{11, 12, 13},
			sumIntCols: []int{9, 10},
			skCols:     map[int]string{2: "dim_resource", 3: "dim_service", 4: "dim_application", 7: "dim_sku", 8: "dim_sku"},
			colKinds: []aggColKind{
				aggColDate, aggColString, aggColInt, aggColInt, aggColInt, aggColString,
