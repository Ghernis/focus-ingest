	...
	return []aggPublishSpec{
		...
		},
		{
			aggCopySpec: aggCopySpec{
				...
				localWhere: fmt.Sprintf(`month_start = '%s'`, m),
				serverCols: `month_start, provider, resource_sk, service_sk, application_sk, environment, prior_month_start, prior_tier_code, new_tier_code, prior_tier_sku_sk, new_tier_sku_sk, prior_unit_rate, new_unit_rate, post_change_quantity, total_qty_on_new_tier, counterfactual_cost_on_new_tier, realized_savings_unit, realized_savings_cost_delta, month_realized_savings, projected_annual_savings, change_direction, refreshed_utc`,
			...
			sumDecCols: []int{11, 12, 13, 14, 15, 16, 17, 18, 19},
		...
		},
		{
			...
			sumDecCols: []int{13, 14, 15, 16, 17, 18, 19, 20, 21},
